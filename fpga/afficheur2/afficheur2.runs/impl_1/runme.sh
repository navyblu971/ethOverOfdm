...
HD_PWD='/home/fabrice/Documents/ethOverOfdm/fpga/afficheur2/afficheur2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log compteur.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source compteur.tcl -notrace
